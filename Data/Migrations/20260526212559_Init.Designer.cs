...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CombinedCourseGroupCourseOffering", b =>
                {
                    b.Property<long>("CombinedCourseGroupsId")
                        .HasColumnType("bigint");

                    b.Property<long>("CourseOfferingsId")
                        .HasColumnType("bigint");

                    b.HasKey("CombinedCourseGroupsId", "CourseOfferingsId");

                    b.HasIndex("CourseOfferingsId");

                    b.ToTable("CombinedCourseGroupCourseOfferings");
                });
            ...
            modelBuilder.Entity("Domain.Entities.CombinedCourseGroup", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("CombinedCourseGroups");
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserGroup", b =>
                {
                    ...
                    b.Property<long?>("ParentUserGroupId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CombinedCourseGroupCourseOffering", b =>
                {
                    b.HasOne("Domain.Entities.CombinedCourseGroup", null)
                        .WithMany()
                        .HasForeignKey("CombinedCourseGroupsId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.CombinedCourseGroup", b =>
                {
                    b.HasOne("Domain.Entities.User", "CreatorUser")
                        .WithMany("CreatedCombinedCourseGroups")
                        .HasForeignKey("CreatorUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.CourseOffering", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.DegreeLevel", null)
                        .WithMany("CourseOfferings")
                        .HasForeignKey("DegreeLevelId");

                    b.HasOne("Domain.Entities.Field", null)
                        .WithMany("CourseOfferings")
                        .HasForeignKey("FieldId");
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("CreatedCombinedCourseGroups");
